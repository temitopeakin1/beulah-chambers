...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Intellectual-Property-Law | Beulah Chambers</title>
...
<body>
  ...
  <section class="link ptb--200" id="link">
    <div class="text"><a href="../index.php">Home</a> <i class="fa fa-long-arrow-right"></i> <a href="#">Practice-Areas</a> <i class="fa fa-long-arrow-right"></i> Intellectual Property Law</div>
</section>
  ...
  <div class="container-fluid white section">
            <div class="row">
              ...
              <div class="right__arbitration">
                <img src="../assets/images/intellectual.jpg">
                <h1>Intellectual Property Law</h1>
                <p>
                  Intellectual property (IP) law is a branch of law that deals with the legal rights of individuals and businesses in relation to their creative works and inventions.
                  The purpose of IP law is to protect the intellectual creations of individuals and businesses from unauthorized use by others.
                  At <strong>KH Bamiwola & Co</strong>, we are involved in several types of Intellectual property rights, such as Patents, Trademarks, Copyrights, Trade secrets and a whole lot.
                  Our strategy involves providing legal framework for creators to protect their rights and prevent unauthorised use or copying without Permission.
                </p>
            </div>
          </div>
        </div>
