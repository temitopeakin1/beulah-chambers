...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Arbitration | Beulah Chambers</title>
...
<body>
  ...
  <section class="link ptb--200" id="link">
    <div class="text"><a href="../index.php">Home</a> <i class="fa fa-long-arrow-right"></i> <a href="#">Practice-Areas</a> <i class="fa fa-long-arrow-right"></i> Arbitration</div>
</section>
  ...
  <div class="container-fluid white section">
            <div class="row">
              ...
              <div class="right__arbitration">
                <img src="../assets/images/arbitration.jpg">
                <h1>Arbitration</h1>
                <p>
                  <strong>Arbitration</strong> is a procedure in which a dispute is submitted,
                  by agreement of parties,to one or more arbitrators who make a binding decision on the dispute.
                  In choosing arbitration, the parties opt for a private dispute resolution procedure instead of going to court.
                  At <em><strong>KH Bamiwola & Co</strong></em> , We follow a comprehensive process of making arbitration seamless where both Parties 
                  won't find reasons not to be satisfied with the entire process.
                </p>
            </div>
          </div>
        </div>
