...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Banking & Debt Recovery | Beulah Chambers</title>
...
<body>
  ...
  <section class="link ptb--200" id="link">
    <div class="text"><a href="../index.php">Home</a> <i class="fa fa-long-arrow-right"></i> <a href="#">Practice-Areas</a> <i class="fa fa-long-arrow-right"></i> Banking & Debt</div>
</section>
  ...
  <div class="container-fluid white section">
            <div class="row">
              ...
              <div class="right__arbitration">
                <img src="../assets/images/debt.jpg">
                <h1>Banking & Debt Recovery</h1>
                <p>
                  <strong>Banking and Debt Recovery law</strong> refers to the legal framework that governs the relationship between 
                  banks and their customers, as well as the process of recovering debts owed by customers.<br>
                  Banking law covers a wide range of issues, including the establishment and operation of banks, the rights and responsibilities of banks and their customers, and the protection of depositors. 
                  The law also regulates the lending and borrowing activities of banks, as well as the handling of customer accounts, payment systems, and other financial transactions.
                  Debt recovery law, on the other hand, deals with the legal process of recovering debts owed by individuals or businesses to creditors. This includes the procedures for filing and pursuing debt recovery actions in court, 
                  as well as the legal remedies available to creditors in the event of default.<br>
                  <em><strong>KH Bamiwola & Co</strong></em> has a good track record in this practice, Recovering debts and Banking in general.
                </p>
            </div>
          </div>
        </div>
