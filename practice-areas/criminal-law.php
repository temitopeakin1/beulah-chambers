...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Criminal-Law | Beulah Chambers</title>
...
<body>
  ...
  <section class="link ptb--200" id="link">
    <div class="text"><a href="../index.php">Home</a> <i class="fa fa-long-arrow-right"></i> <a href="#">Practice-Areas</a> <i class="fa fa-long-arrow-right"></i> Criminal Law</div>
</section>
  ...
  <div class="container-fluid white section">
            <div class="row">
              ...
              <div class="right__arbitration">
                <img src="../assets/images/criminal.jpg">
                <h1>Criminal Law</h1>
                <p>
                  Criminal law is the body of law that deals with crimes and the punishment of 
                  individuals who commit them. Criminal law defines crimes as acts that are
                   prohibited by law and that are punishable by imprisonment, fines, or other 
                   forms of punishment. Criminal law also sets out the procedures that are 
                   followed in criminal trials, including the roles of prosecutors, defense 
                   attorneys, judges, and juries.
                   The main purpose of criminal law is to maintain public order, protect public
                   safety, and ensure that individuals are held accountable for their actions.
                  Criminal law is divided into two main categories: substantive criminal law 
