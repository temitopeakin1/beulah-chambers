...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Election Petitions | Beulah Chambers</title>
...
<body>
  ...
  <section class="link ptb--200" id="link">
    <div class="text"><a href="../index.php">Home</a> <i class="fa fa-long-arrow-right"></i> <a href="#">Practice-Areas</a> <i class="fa fa-long-arrow-right"></i> Election Petitions</div>
</section>
  ...
  <div class="container-fluid white section">
            <div class="row">
              ...
              <div class="right__arbitration">
                <img src="../assets/images/election.jpg">
                <h1>Election Petitions</h1>
                <p>
                  Election petitions law is a branch of law that deals with the legal procedures and processes for challenging the outcome of an election.
                  An election petition is a legal challenge brought by a candidate or voter who disputes the results of an election, and seeks to have the
                  election declared invalid or to have the results overturned.
                  The purpose of election petitions law is to ensure that elections are conducted in a fair, free, and transparent manner, and that the outcome of an election reflects the will of the people. Election petitions can be brought in various types of elections, including presidential, parliamentary, and local government elections.
                </p>
            </div>
          </div>
        </div>
